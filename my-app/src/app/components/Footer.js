                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            ...
                            <span className={footerStyles.logo_name}>Hitesh Ravani Technical Work</span>
                        </div>
                ...
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2023
                            <Link href="/>"> Hitesh Ravani Technical Work.</Link> All rights reserved for  Hitesh Ravani</span>
